...
> https://doi.org/10.5281/zenodo.22287020
...
@software{dhekne_modelstamp_2026,
  ...
  year      = {2026},
  publisher = {Zenodo},
  doi       = {10.5281/zenodo.22287020},
  url       = {https://doi.org/10.5281/zenodo.22287020}
}
```

The version DOI above identifies the archived v0.1.5 release. The project badge
uses the Zenodo concept DOI, `10.5281/zenodo.22047771`, which resolves to the
latest archived Modelstamp release. Use the version DOI when reporting an exact
research environment and the concept DOI only when an evergreen project link is
intended.
